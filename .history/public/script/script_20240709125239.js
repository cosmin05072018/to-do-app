    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, task) {
                ...
                let circleForm = `<form method="POST" action="http://127.0.0.1:8000/check-task=${task.id}" class='form-circle' id='form-circle'>
                    <button type='submit' class='circle-task'></button>
                  </form>`;
