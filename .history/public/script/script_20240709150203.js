    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, task) {
                ...
                let completedClassButton = task.is_completed
                    ? " completed-button"
                    : "";

                let completedClassText = task.is_completed
                    ? " completed-task-text"
                    : "";

                const checkIcon = "/storage/icon-check.svg";

                let li = `<li class="${completedClassText}"> ${task.task_name}</li>`;
                ...
                let circleForm = `<form method="POST" action="check-task" class='form-circle' id='form-circle'>
                    ...
                    <button type='submit' class='circle-task ${completedClassButton}'>
                     ${
                         task.is_completed
