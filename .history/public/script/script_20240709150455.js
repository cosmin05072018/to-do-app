    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, task) {
                ...
                let completedClass = task.is_completed
                    ? " completed-button"
                    : "";
                const checkIcon = "/storage/icon-check.svg";

                let li = $("<li>").text(task.task_name);
                if (completedClass.trim() === "completed-button") {
                    li.addClass("completed-task-text");
                }
                ...
                let circleForm = `<form method="POST" action="check-task" class='form-circle' id='form-circle'>
                    ...
                    <button type='submit' class='circle-task ${completedClass}'>
                     ${
                         task.is_completed
