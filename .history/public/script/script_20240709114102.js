...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            $(".total-items").text(`${data.length} items left`);
            $(".status-tasks").html('<ul class="list-status"><li>All</li><li class="active-link-status">Active</li><li>Completed</li></ul>');
            $('.clear-completed').html('<button class="clear-completed">Clear Completed</button>')
